...
const SECTION_INTROS = [
  ...
  `<p>Film is more than a century old. It has outlived the predictions of its rivals at every stage &mdash; photography, radio, television, video games, streaming. Each new medium threatened to make it obsolete. Each time, it survived. Not by winning the argument about realism, but by refusing to settle it.</p>`,
];
